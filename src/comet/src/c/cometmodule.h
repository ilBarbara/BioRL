...
typedef struct {
    marginkey_t id; /* REQUIRED: the key */
    double weight;
    UT_hash_handle hh; /* REQUIRED: makes this structure hashable */
} margin2weight_t;

extern margin2weight_t *margin2weightHash;
...
void comet_phi_e(int *genes, int k, int n, mutation_data_t *A, int *ctbl, int** kelem, double *score, int *func
                , int co_cutoff, int permutation_iteration
                , double binom_pvalthreshold, double pvalthresh, int use_marginHash);
